...
var final_screen = {
  ...
  stimulus:
    "<h3>Finished!</h3>\
  <p style='width: 800px'>Experiments often end with a final screen, e.g. that contains a completion\
  code so the participant can claim their payment.</p>\
  <p style='width: 800px'>This is a placeholder for that information.</p>",
