...
var write_headers = {
  ...
  func: function () {
    ...
    save_data(
      ...
      "participant_id,trial_index,exp_trial_type,time_elapsed,\
  ...
  trial = {
    ...
    timeline: [
      ...
      },
      {
        ...
        trial_duration: 2000,
        post_trial_gap: 500,
        data: { exp_trial_type: "observation", observation_label: label },
...
function director_trial(target_object, partner_id) {
  ...
  var subtrial2 = {
    ...
    on_finish: function (data) {
      ...
      data.exp_trial_type = "director"; //add this to data so it is saved to data file
