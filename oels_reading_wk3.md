...
We'll start by looking at grammaticality judgments - not because I am especially interested in syntax, but because this is a very simple sort of data to collect (in its simplest form, just yes/no responses on whether or not a particular sentence could be produced by a native speaker), so coding it up is going to be easy. We'll look at a paper published in 2011, in the early days of widespread use of online data collection, which verifies that in-lab judgments match those collected online from MTurk. Then in this week's practical you'll get a chance to look at some very simple jsPsych code for a grammaticality judgment experiment.
